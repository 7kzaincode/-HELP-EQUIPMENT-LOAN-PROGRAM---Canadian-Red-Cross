        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
                <div className="relative w-10 h-10 bg-[#ed1b2e] flex items-center justify-center rounded-lg shadow-sm">
      ...
      <footer className="bg-white border-t border-gray-100 py-12 px-6 md:px-12">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-end gap-6">
          ...
          <div className="flex flex-col items-center md:items-end group cursor-default">
            <div className="h-px w-0 group-hover:w-full bg-red-100 transition-all duration-1000 mb-2"></div>
            <p className="text-xs text-gray-400 font-bold tracking-tight">
              portal engineering <span className="text-[#ed1b2e] font-black italic hover:underline decoration-red-200 decoration-2 ml-1">made by ali khan</span>
            </p>
          </div>
        </div>
      </footer>
